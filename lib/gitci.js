 ...
 * @param  {boolean} createWorkspace Create the workspace if it does not exists.
 */
function configureGitCI(self, name, gitRepository, branch, workspaceFolder, configFile, pullInterval, createWorkspace) {
...
function prepareGit(self) {
    ...
    var repositoryOptions = {
        "prepareBasePath": !fs.existsSync(self._options.workspaceFolder)
    }
    ...
    debuglog("Looking for the folder workspace.");
 ...
 */
var createGitCI = function (name, gitRepository, branch, workspaceFolder, configFile, pullInterval, createWorkspace) {
    var gitCI = new GitCI();
    configureGitCI(gitCI, name, gitRepository, branch, workspaceFolder, configFile, pullInterval, createWorkspace);
    return gitCI;
}
